...
class FlowersRepo {
  ...
  Future<void> updateFlower(Flower flower) async {
    final docReference = fireStore.collection('flowers').doc(flower.title);
...
final _rawFlowersData = [
  ...
  //       'https://images.unsplash.com/photo-1656226823951-5d8b082a4b2d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60',
  //   'price': 14.99,
  //   'count': 1,
  //   'addedToCart': false,
  // },
